	 ...
	 <div style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form:form action="/spring_web/add_covid_success_jsp_form" method="post" modelAttribute="map">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                   <span class="input-group-addon"><i class="glyphicon glyphicon-map-marker"></i></span>
                                    ...
                                    <div><form:errors path="visit_date" cssClass="error"/></div>
                            <div style="margin-bottom: 25px" class="input-group">
                                   <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                                    <form:input path="visit_date" id="visit_date" type="text" class="form-control" placeholder="Visit Date"/>
